...
class AICaring_Dataset_v1(Dataset):
    ...
    def setup(self):
        ...
        file_path = os.path.join(self.stat_dir_name, "new_experts_smaller.pickle")        
        ...
        for k, ex in enumerate(exercise_list):
            for j, level in enumerate(levels):
                self.number_demos[k] = len(x[ex][level])            
    ...
    def __getitem__(self, index):
        ...
        data_element['demo'] = self.files[task_index][new_index]
